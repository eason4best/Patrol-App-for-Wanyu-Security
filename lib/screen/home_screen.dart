...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    _future = widget.bloc.initialize(member: member);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: FutureBuilder<void>(
            future: _future,
            builder: (context, _) {
              return StreamBuilder<HomeScreenModel>(
                          ...
                          child: Row(
                            ...
                            children: [
                              PunchCardWidget(
                                title: '上班',
                                onPressed: () {
                                  if (snapshot.data!.canGetLocation) {
                                    widget.bloc
...
class NoLocationPermissionDialog extends StatelessWidget {
  const NoLocationPermissionDialog({
    Key? key,
...
class NoLocationServiceDialog extends StatelessWidget {
  const NoLocationServiceDialog({
    Key? key,
    required this.mounted,
  }) : super(key: key);
