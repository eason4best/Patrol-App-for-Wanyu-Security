          ...
          child: Column(
            children: [
              SingleChildScrollView(
                ...
                child: Padding(
                  padding: EdgeInsets.all(widget
                          .bloc.model.signableDocumentTab!.pinnedDocs.isNotEmpty
                      ? 16
                      : 0),
                  child: Row(
                    children: List.generate(
                      widget.bloc.model.signableDocumentTab!.pinnedDocs.length,
                      (index) => Container(
              ...
              ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: widget.bloc.model.signableDocumentTab!.docs!.length,
